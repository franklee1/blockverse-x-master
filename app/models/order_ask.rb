...
class OrderAsk < Order
  ...
  def referee_hold_account
    member.referred_by.get_account(ask)
  end

  def referee_hold_account!
    Account.lock.find_by!(member_id: member.referred_by_id, currency_id: ask)
  end
  ...
  def referee_expect_account
    member.referred_by.get_account(bid)
  end

  def referee_expect_account!
    Account.lock.find_by!(member_id: member.referred_by_id, currency_id: bid)
  end
